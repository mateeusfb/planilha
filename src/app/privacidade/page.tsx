    ...
    <div className="min-h-screen bg-slate-50 py-12 px-4">
      <div className="max-w-2xl mx-auto bg-white rounded-2xl border border-slate-200 p-8 shadow-sm">
        ...
        <div className="space-y-6 text-sm text-slate-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-base font-bold text-slate-800 mb-2">3. Armazenamento e segurança</h2>
            <ul className="list-disc ml-5 space-y-1">
              <li>Seus dados são armazenados no Supabase (infraestrutura AWS), com criptografia em trânsito (TLS) e em repouso.</li>
              <li>Senhas são criptografadas com bcrypt — nem nos temos acesso a elas.</li>
          ...
          <section>
            ...
            <p>De acordo com a Lei Geral de Protecao de Dados (Lei 13.709/2018), você tem direito a:</p>
            <ul className="list-disc ml-5 mt-2 space-y-1">
